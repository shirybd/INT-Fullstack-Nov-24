...
const operation  = prompt("Which operation would you like to do ? \n (1) - minimum \n (2) - maximum");

let minResault : number= 100;
let maxResault : number= 0;
if(Number(operation)===1 ||  Number(operation)===2)
{
    const FullName  = prompt("Please enter your full name");
    let Grade = prompt("please enter your grades (0-100) (Click 'cancel' to finish input)");
    while (Grade!=null)
    {
